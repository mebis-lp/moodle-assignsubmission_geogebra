...
$string['dragndrop'] = '在 GeoGebra Java 程序部分拖放 GeoGebra 文件';
$string['enabled_help'] = '如果已经启用, 学生们就能用 GeoGebra 提交.';
$string['eventassessableuploaded'] = 'GeoGebra 提交已经上传:';
$string['geogebrasubmission'] = '允许 GeoGebra 提交';
$string['geometry'] = '几何';
$string['ggbtemplates'] = '选择模板';
$string['ggbturl'] = '学生使用的 GeoGebra 模板';
$string['ggbturl_help'] = '为学生用作模板的格局或 GeoGebra 素材.';
